...
if ( ! class_exists( 'ic_commerce_audit_log_lite_addons' ) ) {
	class ic_commerce_audit_log_lite_addons extends ic_commerce_audit_log_lite_function{
		private $token;
		...
		public $plugin_key  =   "icwcauditloglite";
